...
def save_stream():
    ...
    f=open("nfl_data_"+str(dt.hour)+str(dt.minute)+str(dt.second)+".pickle","wb")
    #stream.sample(languages=["en"])
    stream.filter(track=["nfl","superbowl","football","americanfootball","touchdown","American Football"],languages=['en'])
